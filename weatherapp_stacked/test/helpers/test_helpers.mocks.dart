...
class MockWeatherReposetoryService extends _i1.Mock
    implements _i7.WeatherReposetoryService {
  @override
  _i5.Future<WeatherModel> getWeatherAPI({required String city}) =>
      (super.noSuchMethod(
        Invocation.method(
          #getWeatherAPI,
          [],
        ...
        returnValue: _i5.Future<WeatherModel>.value(),
        // ignore: null_argument_to_non_null_type
        returnValueForMissingStub: _i5.Future<WeatherModel>.value(),
      ) as _i5.Future<WeatherModel>);
}
